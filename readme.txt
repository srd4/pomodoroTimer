...
I created a function that recognizes if the directory of our database "tomatoBase.db" already exist on the directory of this very same script. In case it doesn't, it executes your first pomodoro, where yo have to write a brief description of what you are going to be working on and the code you'll give to it. Be careful, it is not yet very easy to modify information that the program wrote on database so you better think your code names right in order to have good measurement of your activities later on (although database is always updates after countdowns, so you have a few minutes to re-think your codenames).
